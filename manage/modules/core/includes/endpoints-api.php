...
$map_apis_policy->define(
    new Priv\PrivModules(view : true, endpoints : true),
    new Priv\PrivCore(view : true, settings: true)
);
AdminApi::register_endpoint(new ApiEndPoint(
    ...
    method : function(AdminApi $Api, array $args, ApiEndPoint $Endpoint) {
        ...
        //Load all endpoints:
        foreach (APage::$modules->get_all_installed() as $module_name) {
            //All installed known modules:
            $module =  APage::$modules->module_installed($module_name);
