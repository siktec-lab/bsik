...
class FPage extends Base {   
    ...
    //The request object:
    public static FPageRequest $request;
    ...
    final public static function error_page($code = 0, bool $exit = true)
    {
        ...
        FPageHttpHeaders::send_response_code($code);
    ...
    final public static function load_defined_pages() : int {
        ...
        self::$pages = self::$db->where("status", FPageStatus::state_translate("active"))
                                ->map("name")
                                ->arrayBuilder()
